...
public class LdapTestEnvironment {
  ...
  public void startServer() throws Exception {
    ...
    ldapService.setTransports(new TcpTransport(10105));
  ...
  public String createUserUid(String user, String group, String firstname, String lastname, String email) throws Exception {
    Dn dn = new Dn("uid=" + user + ",ou=" + group + ",o=camunda,c=org");
    createUser(user, firstname, lastname, email, dn);
    return dn.getNormName();
  }

  public String createUserCN(String user, String group, String firstname, String lastname, String email) throws Exception {
    Dn dn = new Dn("cn=" + lastname + "\\," + firstname + ",ou=" + group + ",o=camunda,c=org");
    createUser(user, firstname, lastname, email, dn);
    return dn.getNormName();
  }

  public void createUser(String user, String firstname, String lastname,
  ...
  public void createRole(String roleName, String... users) throws Exception {
